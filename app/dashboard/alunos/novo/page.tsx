...
export default function NovoAlunoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const novoAluno = { nome, faixa, graus, mensalidade, dataMatricula }
    
    // Aqui você fará o fetch para sua API futuramente
    console.log('Salvando no JiuPro:', novoAluno)

    setTimeout(() => {
      setIsLoading(false)
      // Redireciona de volta para a listagem do dashboard
